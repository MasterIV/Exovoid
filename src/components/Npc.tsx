...
function NpcAction({
  ...
  return (
    <TableRow>
      ...
      <TableCell>
        <Value width={75} name={"aptitude"} value={a} onChange={onChange} />
      </TableCell>
      <TableCell>
        <Value width={75} name={"expertise"} value={e} onChange={onChange} />
      </TableCell>
      <TableCell>
        <Value
          width={75}
      ...
      <TableCell>
        <Btn onClick={() => onRoll(a, e, 0, meta)} fullWidth>
          <DicePool {...pool} />
        </Btn>
      </TableCell>
    </TableRow>
...
export default function Npc({
  ...
  const removeNpc = (e: any) => {
    e.stopPropagation();
    if (window.confirm("Remove Npc?")) onRemove();
  };
  ...
  return (
    ...
    >
      <AccordionSummary expandIcon={<ExpandMoreIcon />}>
        ...
        <Btn size="small" color={"error"} disabled={locked} onClick={removeNpc}>
          Remove
        </Btn>
      </AccordionSummary>
        ...
        <Grid container direction="column" spacing={2}>
          <Grid item container spacing={2} alignItems="center">
            ...
            <Grid xs={1} item textAlign="center">
              <Checkbox
                title="Minion?"
                checked={Boolean(props.minion)}
                onChange={(e) => onChange("minion", e.target.checked)}
              />
            </Grid>
          ...
          <Grid item container spacing={2} alignItems="center">
            ...
            <Grid item>
              <Btn onClick={joinCombat}>Join Combat</Btn>
            </Grid>
            <Grid item>
            ...
            <Grid item>
              <Btn fullWidth onClick={() => performAction(actions[action])}>
                Execute
              </Btn>
            </Grid>
          </Grid>
